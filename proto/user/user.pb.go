...
type User struct {
	...
	PhoneNumber   int64                  `protobuf:"varint,7,opt,name=phone_number,json=phoneNumber,proto3" json:"phone_number,omitempty"`
...
const file_user_user_proto_rawDesc = "" +
	"\n" +
	"\x0fuser/user.proto\x12\x04user\"\xbe\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	"\fphone_number\x18\a \x01(\x03R\vphoneNumber\"3\n" +
	...
	"\fphone_number\x18\x05 \x01(\x03R\vphoneNumber\"\"\n" +
	"\x10RegisterResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id2\xb6\x03\n" +
	"\vUserService\x12?\n" +
	"\n" +
	"CreateUser\x12\x17.user.CreateUserRequest\x1a\x18.user.CreateUserResponse\x129\n" +
	"\bReadUser\x12\x15.user.ReadUserRequest\x1a\x16.user.ReadUserResponse\x12?\n" +
	"\n" +
...
var file_user_user_proto_depIdxs = []int32{
	...
	0,  // 1: user.ReadUserResponse.user:type_name -> user.User
	...
	3,  // 5: user.UserService.ReadUser:input_type -> user.ReadUserRequest
	...
	11, // 9: user.UserService.Login:input_type -> user.LoginRequest
	13, // 10: user.UserService.Register:input_type -> user.RegisterRequest
	2,  // 11: user.UserService.CreateUser:output_type -> user.CreateUserResponse
	4,  // 12: user.UserService.ReadUser:output_type -> user.ReadUserResponse
	...
	14, // 17: user.UserService.Register:output_type -> user.RegisterResponse
