...
const (
	...
	BookService_ReadBook_FullMethodName   = "/book.BookService/ReadBook"
...
func (c *bookServiceClient) ReadBook(ctx context.Context, in *ReadBookRequest, opts ...grpc.CallOption) (*ReadBookResponse, error) {
	...
	err := c.cc.Invoke(ctx, BookService_ReadBook_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BookService_ReadBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookService_ReadBook_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
